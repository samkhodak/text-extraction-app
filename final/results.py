...
from utilities.ml_functions import get_languages, text_detection, detect_handwriting_update_later
...
class Results(MethodView):
    ...
    def get(self):
        ...
        return render_template('results.html', original_image=encoded_image.decode('utf-8'), original_extracted_text=detected_text, 
                            languages=self._languages, romanized_blocks=array_of_romanized)
